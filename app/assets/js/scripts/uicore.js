...
remote.getCurrentWebContents().on('devtools-opened', () => {
    console.log('%cКонсоль темна и полна ужасов....', 'color: white; -webkit-text-stroke: 4px #a02d2a; font-size: 60px; font-weight: bold')
    console.log('%cЕсли вам сказали вставить что-то сюда, вас обманывают.', 'font-size: 16px')
    console.log('%cЕсли вы точно не знаете, что делаете, закройте это окно.', 'font-size: 16px')
})
    ...
    ipcRenderer.on('autoUpdateNotification', (event, arg, info) => {
        switch(arg){
            case 'checking-for-update':
                loggerAutoUpdater.log('Проверка обновления..')
            ...
            case 'update-downloaded':
                loggerAutoUpdaterSuccess.log('Обновение ' + info.version + ' готово к установке.')
                settingsUpdateButtonStatus('Установить сейчас', false, () => {
                    if(!isDev){
            ...
            case 'update-not-available':
                loggerAutoUpdater.log('Новых новостей не найдено.')
